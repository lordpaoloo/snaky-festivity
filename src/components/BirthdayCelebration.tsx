...
import { Cake } from 'lucide-react'; // Change import to Cake
    ...
    <div className="absolute inset-0 flex items-center justify-center z-10 overflow-hidden">
      <div className="bg-white bg-opacity-90 rounded-2xl p-8 shadow-lg text-center max-w-xs animate-scale-in">
        <div className="mb-4 flex justify-center">
          <Cake className="h-10 w-10 text-yellow-500" /> {/* Change icon to Cake */}
        </div>
        <h2 className="text-3xl font-bold text-purple-700 mb-2 animate-birthday-bounce">
          Happy Birthday Omer!
        </h2>
        <p className="text-gray-700">
          You made up level 22 🎉 wish for you a good life
          your dear friend <span className="font-bold">Yousef</span>
        </p>
      </div>
